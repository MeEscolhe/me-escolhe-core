...
const swaggerSpecs = {
  ...
  paths: {
    ...
    "/hardSkills": require("../doc/controllers/hard")
    .withoutParameters,
    "/hardSkills/{id}": require("../doc/controllers/hard")
    .withParameters,

    "/labs": require("../doc/controllers/lab")
    .withoutParameters,
    "/labs/{id}": require("../doc/controllers/lab")
    .withParameters,

    "/languages": require("../doc/controllers/language")
    .withoutParameters,
    "/languages/{id}": require("../doc/controllers/language")
    .withParameters,

    "/phases": require("../doc/controllers/phase")
    .withoutParameters,
    "/phases/{id}": require("../doc/controllers/phase")
    .withParameters,

    "/projects": require("../doc/controllers/project")
    .withoutParameters,
    "/projects/{id}": require("../doc/controllers/project")
    .withParameters,

    "/selections": require("../doc/controllers/selection")
    .withoutParameters,
    "/selections/{id}": require("../doc/controllers/selection")
    .withParameters,

    "/skills": require("../doc/controllers/skill")
    .withoutParameters,
    "/skills/{id}": require("../doc/controllers/skill")
    .withParameters,

    "/softSkills": require("../doc/controllers/soft")
    .withoutParameters,
    "/softSkills/{id}": require("../doc/controllers/soft")
    .withParameters,

    "/students": require("../doc/controllers/student")
    .withoutParameters,
    "/students/{id}": require("../doc/controllers/student")
    .withParameters,

    "/teachers": require("../doc/controllers/teacher")
    .withoutParameters,
    "/teachers/{id}": require("../doc/controllers/teacher")
    .withParameters,
